...
const float MOTOR_MAX_SPEED = 300;        // motor max speed, given by DualVNH5019MotorShield library
const float REVERSE_TIME = 5000;          // Time to have motors in reverse mode
